...
// Initialize and test the bitboards used for slide-15 puzzle variant
void init_slide() {
	for (Square from = SQ_A1; from <= SQ_MAX; ++from) {
		...
		for (Square to = SQ_A1; to <= SQ_MAX; ++to) {
			...
			if (square_bb(to) & shifted_wall) {
				SlideSquare[from][to] = to - d;
			} else {
				SlideSquare[from][to] = to;
			}
		}
	}

	// validate SlideFromBB
	assert(SlideFromBB[SQ_A1] == square_bb(SQ_A1) | square_bb(SQ_A1 + NORTH) | square_bb(SQ_A1 + EAST) | square_bb(SQ_A1 + NORTH_EAST));
    assert(SlideFromBB[SQ_A2] == square_bb(SQ_A1) | square_bb(SQ_A1 + NORTH) | square_bb(SQ_A1 + EAST) | square_bb(SQ_A1 + NORTH_EAST));
    assert(SlideFromBB[SQ_B1] == square_bb(SQ_A1) | square_bb(SQ_A1 + NORTH) | square_bb(SQ_A1 + EAST) | square_bb(SQ_A1 + NORTH_EAST));
    assert(SlideFromBB[SQ_B2] == square_bb(SQ_A1) | square_bb(SQ_A1 + NORTH) | square_bb(SQ_A1 + EAST) | square_bb(SQ_A1 + NORTH_EAST));

    // validate SlideToBB
    assert(SlideToBB[SQ_A1][SQ_A3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_A1][SQ_A4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_A1][SQ_B3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_A1][SQ_B4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));

    assert(SlideToBB[SQ_A2][SQ_A3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_A2][SQ_A4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_A2][SQ_B3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_A2][SQ_B4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));

    assert(SlideToBB[SQ_B1][SQ_A3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_B1][SQ_A4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_B1][SQ_B3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_B1][SQ_B4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));

    assert(SlideToBB[SQ_B2][SQ_A3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_B2][SQ_A4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_B2][SQ_B3] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));
    assert(SlideToBB[SQ_B2][SQ_B4] == square_bb(SQ_A3) | square_bb(SQ_A3 + NORTH) | square_bb(SQ_A3 + EAST) | square_bb(SQ_A3 + NORTH_EAST));

    // validate SlideDir
    assert(SlideDir[SQ_A1][SQ_A3] == NORTH * 2);
    assert(SlideDir[SQ_A1][SQ_A4] == NORTH * 2);
    assert(SlideDir[SQ_A1][SQ_B3] == NORTH * 2);
    assert(SlideDir[SQ_A1][SQ_B4] == NORTH * 2);

    assert(SlideDir[SQ_A2][SQ_A3] == NORTH * 2);
    assert(SlideDir[SQ_A2][SQ_A4] == NORTH * 2);
    assert(SlideDir[SQ_A2][SQ_B3] == NORTH * 2);
    assert(SlideDir[SQ_A2][SQ_B4] == NORTH * 2);

    assert(SlideDir[SQ_B1][SQ_A3] == NORTH * 2);
    assert(SlideDir[SQ_B1][SQ_A4] == NORTH * 2);
    assert(SlideDir[SQ_B1][SQ_B3] == NORTH * 2);
    assert(SlideDir[SQ_B1][SQ_B4] == NORTH * 2);

    assert(SlideDir[SQ_B2][SQ_A3] == NORTH * 2);
    assert(SlideDir[SQ_B2][SQ_A4] == NORTH * 2);
    assert(SlideDir[SQ_B2][SQ_B3] == NORTH * 2);
    assert(SlideDir[SQ_B2][SQ_B4] == NORTH * 2);

    // validate SlideSquare
    assert(SlideSquare[SQ_A1][SQ_A3] == SQ_A1);
    assert(SlideSquare[SQ_A1][SQ_A4] == SQ_A2);
    assert(SlideSquare[SQ_A1][SQ_B3] == SQ_B1);
    assert(SlideSquare[SQ_A1][SQ_B4] == SQ_B2);

    assert(SlideSquare[SQ_A2][SQ_A3] == SQ_A1);
    assert(SlideSquare[SQ_A2][SQ_A4] == SQ_A2);
    assert(SlideSquare[SQ_A2][SQ_B3] == SQ_B1);
    assert(SlideSquare[SQ_A2][SQ_B4] == SQ_B2);

    assert(SlideSquare[SQ_B1][SQ_A3] == SQ_A1);
    assert(SlideSquare[SQ_B1][SQ_A4] == SQ_A2);
    assert(SlideSquare[SQ_B1][SQ_B3] == SQ_B1);
    assert(SlideSquare[SQ_B1][SQ_B4] == SQ_B2);

    assert(SlideSquare[SQ_B2][SQ_A3] == SQ_A1);
    assert(SlideSquare[SQ_B2][SQ_A4] == SQ_A2);
    assert(SlideSquare[SQ_B2][SQ_B3] == SQ_B1);
    assert(SlideSquare[SQ_B2][SQ_B4] == SQ_B2);
}
...
void init_magics(Bitboard table[], Magic magics[], std::map<Direction, int> directions) {
	...
	for (Square s = SQ_A1; s <= SQ_MAX; ++s) {
		...
		m.mask = (MT == LAME_LEAPER ? lame_leaper_path(directions, s) : sliding_attack < MT == HOPPER ? UNLIMITED_RIDER
																									  : MT > (directions, s, 0)) &
				~edges;
#ifdef LARGEBOARDS
